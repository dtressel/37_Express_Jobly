...
describe("findFiltered: find companies with filtering parameters", function () {
  test("works: filtering by name regardless of capitalization match", async function () {
    ...
    const expectedCompanies = [{handle: "c2",
                               name: "C2",
                               description: "Desc2",
                               numEmployees: 2,
                               logoUrl: "http://c2.img"}];
  ...
  test("works: filtering by minEmployees", async function () {
    ...
    const company1 = {handle: "c2",
                      name: "C2",
                      description: "Desc2",
                      numEmployees: 2,
                      logoUrl: "http://c2.img"};
    const company2 = {handle: "c3",
                      name: "C3",
                      description: "Desc3",
                      numEmployees: 3,
                      logoUrl: "http://c3.img"};
  ...
  test("works: filtering by maxEmployees", async function () {
    ...
    const company1 = {handle: "c1",
                      name: "C1",
                      description: "Desc1",
                      numEmployees: 1,
                      logoUrl: "http://c1.img"};
    const company2 = {handle: "c2",
                      name: "C2",
                      description: "Desc2",
                      numEmployees: 2,
                      logoUrl: "http://c2.img"};
  ...
  test("works: filtering by a range (both min and max employees)", async function () {
    ...
    const expectedCompany = [{handle: "c2",
                             name: "C2",
                             description: "Desc2",
                             numEmployees: 2,
                             logoUrl: "http://c2.img"}];
